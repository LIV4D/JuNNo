...
from ..j_utils.parallelism import parallel_exec, intime_generator, N_THREAD
from ..j_utils.math import interval, cartesian
from ..j_utils.collections import if_none, AttributeDict, istypeof_or_listof, istypeof_or_collectionof
import weakref
...
class AbstractDataSet(metaclass=ABCMeta):
    ...
    def as_cache(self, n=1, start=0, end=None, columns=None, ncore=1, name=None):
        ...
        dataset = NumPyDataSet(name=name, data_dict=data)
