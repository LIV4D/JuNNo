...
(function ($, window, document, undefined) {
    ...
    */
    ...
    var imageViewHtml = '<div class="iv-loader"></div> <div class="iv-snap-view">' + '<div class="iv-snap-image-wrap">' + '<div class="iv-snap-handle"></div>' + '</div>' + '<div class="iv-zoom-slider"><div class="iv-zoom-handle"></div></div></div>' + '<div class="iv-legend"></div>' + '<div class="iv-image-view" ><div class="iv-image-wrap" ></div></div>';
    ...
    function ImageViewer(container, options) {
        ...
        self.legend = container.find('.iv-legend');
    ...
    ImageViewer.prototype = {
        ...
        load: function (image, hiResImg, legend) {
            var self = this,
                container = this.container;
